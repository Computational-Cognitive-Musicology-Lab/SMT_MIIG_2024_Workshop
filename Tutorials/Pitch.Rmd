...
<div id='pitchentropy-hint'>

For example, you could compare the entropy of an absolute representation of pitch, to one where the octave information is removed.
Or compare the entropy of scale degrees and *key* information.
...
> **Is information content in the Chorales and CoCoPops similarly parititioned?**
...
```{r mutualrhythm-hint-1}
# It depends on what pitch representation we have
