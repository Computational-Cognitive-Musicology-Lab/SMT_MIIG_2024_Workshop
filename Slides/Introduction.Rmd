...
+ Comparing musical definitions using humdrum$_{\mathbb{R}}$
  + --- Nat
...
+ The humdrum data *syntax*
+ The Unix-based humdrum *toolkit*
...
Tens of thousands of scores available in humdrum's `**kern` format.
+ Possible to include *any* arbitrary information
  + Harmonic information
  + Formal information
  + Dance steps, emotion annotations, fingerings, etc.
